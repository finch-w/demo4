...
public class SysAuthorityDto extends BaseDto {
    ...
    @Builder
    public SysAuthorityDto(Long page, Long size, String id, String createUser, String updateUser, Date createDate, Date updateDate, Date createDateStart, Date createDateEnd, Date updateDateStart, Date updateDateEnd, String name) {
