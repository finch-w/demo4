package com.yuan.demojooqjpa2.commons.dao.impl;

import com.yuan.demojooqjpa2.commons.dao.BaseRepository;
import com.yuan.demojooqjpa2.commons.utils.BeanUtils;
...
public class BaseRepositoryImpl<T, ID> extends SimpleJpaRepository<T, ID> implements BaseRepository<T, ID> {
    ...
    @Override
    public void insert(org.jooq.Query query) {
    ...
    @SuppressWarnings("Duplicates")
    @Override
    public void delete(org.jooq.Query query) {
        Query nativeQuery = entityManager.createNativeQuery(query.getSQL());
        List<Object> bindValues = query.getBindValues();
        for (int i = 0; i < bindValues.size(); i++) {
            nativeQuery.setParameter(i + 1, bindValues.get(i));
    ...
    @SuppressWarnings("Duplicates")
    @Override
    public void update(org.jooq.Query query) {
        Query nativeQuery = entityManager.createNativeQuery(query.getSQL());
        List<Object> bindValues = query.getBindValues();
        for (int i = 0; i < bindValues.size(); i++) {
            nativeQuery.setParameter(i + 1, bindValues.get(i));
    ...
    @Override
    public Optional<T> getOneByQuery(org.jooq.Query query) {
    ...
    @Override
    public <R> Optional<R> getOneByQuery(org.jooq.Query query, Class<R> requireType) {
    ...
    @Override
    public Optional<Map> getOneByQueryInMap(org.jooq.Query query) {
