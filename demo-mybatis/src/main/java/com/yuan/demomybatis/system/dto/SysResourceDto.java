...
public class SysResourceDto extends BaseDto {
    ...
    @Builder
    public SysResourceDto(Integer page, Integer size, String id, String createUser, String updateUser, Date createDate, Date updateDate, Date createDateStart, Date createDateEnd, Date updateDateStart, Date updateDateEnd, String name) {
